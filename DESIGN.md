...
| Paused | Semi-transparent dark overlay; RESUME, RESTART, and EXIT options shown; player types word to choose; Esc opens pause but cannot close it — must type RESUME or EXIT | Until RESUME or EXIT typed |
